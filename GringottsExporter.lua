...
local function GringottsPrepareResult(name)
  local itemCounts = GringottsGetItemCounts(name)
...
SlashCmdList["GRINGOTTS_SHOW"] = function(msg)
  ...
  local b64Result = GringottsPrepareResult(charName)
  GringottsEditBox_Show(b64Result)
end

SLASH_GRINGOTTS_SHOW_OTHER1 = "/ggeshowo"
SlashCmdList["GRINGOTTS_SHOW_OTHER"] = function(msg)
  local b64Result = GringottsPrepareResult(msg)
  GringottsEditBox_Show(b64Result)
end
